...
MEDIA_ROOT = config.get_media_dir()
print(f"MEDIA_ROOT is set to: {MEDIA_ROOT}")  # Debugging

SITE_URL = 'http://localhost:8000'  # Change to your site’s actual URL

CSRF_TRUSTED_ORIGINS = [
    'http://localhost:8000',  # Add the same URL as SITE_URL or your site’s URL
]
...
# settings.py
# CORS_ALLOW_ALL_ORIGINS = True  # For testing purposes; make it more restrictive in production.
